...
const AddProducts = () => {
  ...
  return (
    <div className='bg-gray-950 h-screen flex justify-center items-center'>
      ...
      <form className='flex justify-center flex-col border-[#dadada6e] items-center border-[0.5px] rounded-lg min:h-[400px] w-[400px] bg-gray-800 text-[#fff] gap-y-3 font-poppins px-6 py-6'>
